...
module.exports = function(RED) {
  ...
  var PersonalityInsightsV3 = require(
    'watson-developer-cloud/personality-insights/v3',
  ),
      ...
      wc(msg.payload, function(length) {
        if (length < 100) {
          ...
          node.status({
            fill: 'red',
            shape: 'ring',
            text: 'insufficient words submitted',
          });
          node.error(message, msg);
          return;
        }
