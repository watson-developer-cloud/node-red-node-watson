...
module.exports = function(RED) {
  ...
  function createRankerNode(config) {
    ...
    this.on('input', function(msg) {
      setupRankRetrieveNode(msg, config, this, function(retrieve_and_rank) {
        ...
        config.rankername !== ''
          ? rankername = config.rankername
          : rankername = msg.ranker_name;
        if (rankername) {
        ...
        retrieve_and_rank.createRanker(params, function(err, res) {
          handleWatsonCallback(null, node, msg, err, res, function() {
            node.status({
              fill: 'blue',
              shape: 'ring',
              text: 'Training data uploaded. Ranker is training',
            });
  ...
  function rankerSettingsNode(config) {
    ...
    this.on('input', function(msg) {
      setupRankRetrieveNode(msg, config, this, function(retrieve_and_rank) {
        var rankerid;
        config.rankerid !== ''
          ? rankerid = config.rankerid
          : rankerid = msg.ranker_id;
        var params = {
          ranker_id: rankerid,
        };
        switch (config.mode) {
    ...
    this.on('input', function(msg) {
      setupRankRetrieveNode(msg, config, this, function(retrieve_and_rank) {
        ...
        config.clustername !== ''
          ...
          : clustername = msg.payload;
        var params = {
          cluster_name: clustername,
          cluster_size: config.clustersize !== 'free'
            ? config.clustersize
            : null,
        };
      ...
      setupRankRetrieveNode(msg, config, this, function(retrieve_and_rank) {
        ...
        var uploadConfig = function(filePath, cb) {
          ...
          node.status({
            fill: 'blue',
            shape: 'ring',
            text: 'Uploading solr configuration...',
          });
        ...
        switch (config.mode) {
          case 'list':
            node.status({
              fill: 'blue',
              shape: 'ring',
              text: 'Getting solr configurations...',
            });
          ...
          case 'info':
            if (params.cluster_id && params.config_name) {
              ...
              var stream_url = function(file, location, cb) {
                ...
                request(location).auth(username, password).pipe(wstream);
              };
  ...
  RED.nodes.registerType(
    'watson-retrieve-rank-credentials',
    serviceCredentialsConfigurationNode,
  );
  RED.nodes.registerType(
    'watson-retrieve-rank-create-cluster',
    createClusterNode,
  );

  RED.nodes.registerType(
    'watson-retrieve-rank-cluster-settings',
    clusterSettingsNode,
    {
      credentials: {
        username: { type: 'text' },
  ...
  RED.nodes.registerType(
    'watson-retrieve-rank-upload-solr-configuration',
    uploadSolrConfigurationNode,
    {
      credentials: {
        username: { type: 'text' },
        password: { type: 'password' },
  ...
  RED.nodes.registerType(
    'watson-retrieve-rank-solr-configuration-settings',
    solrConfigurationSettingsNode,
    {
      credentials: {
        username: { type: 'text' },
        password: { type: 'password' },
  ...
  RED.nodes.registerType(
    'watson-retrieve-rank-solr-collection',
    solrCollectionNode,
    {
      credentials: {
        username: { type: 'text' },
  ...
  RED.nodes.registerType(
    'watson-retrieve-rank-create-ranker',
    createRankerNode,
    {
      credentials: {
        username: { type: 'text' },
  ...
  RED.nodes.registerType(
    'watson-retrieve-rank-ranker-settings',
    rankerSettingsNode,
    {
      credentials: {
        username: { type: 'text' },
  ...
  RED.nodes.registerType(
    'watson-retrieve-rank-search-and-rank',
    searchAndRankNode,
    {
      credentials: {
        username: { type: 'text' },
        ...
        retrieve_and_rank.rankerStatus(params, function(err, res) {
          if (err) {
            ...
            switch (res.status) {
              ...
              default:
                node.status({});
                var message = 'Ranker training status: ' +
                  res.status +
                  ', description: ' +
